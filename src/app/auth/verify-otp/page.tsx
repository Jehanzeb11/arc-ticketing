...
import VerifyForm from "@/components/common/Form/userForm/Verify";
...
const VerifyOTP: React.FC<LoginProps> = () => {
        ...
        >
          ...
          <div className="auth_form">
            ...
            <Typography
              ...
              mb={2}
            >
              Please fullfill the following requirements to verify your account
            </Typography>
            <VerifyForm />
          </div>
        </Grid>
